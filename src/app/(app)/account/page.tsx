...
export default async function Account() {
  ...
  return (
    <div className="max-w-md space-y-4">
      <h1 className="text-[22px] font-semibold leading-tight">Change password</h1>
      ...
      <section className="panel space-y-2 p-4"><h2 className="text-[14px] font-semibold">Two-factor authentication</h2><p className="text-[13px] text-muted">{c.totp_enabled ? 'Enabled on this account.' : 'Optional for your role; required for Superadmin and HQ Admin.'}</p>
